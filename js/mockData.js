...
const MockData = {
  ...
  // Reconcile Ecopay (Báo cáo đối soát thanh toán) Data matching PRD
  getReconcileEcopayData() {
    return [
      {
        stt: 1,
        reconcileCode: 'R_102107_08082025_094010_083',
        createdAt: '08-08-2025 09:40:10',
        periodRange: '08-08-2025 09:28 ~ 08-08-2025 09:29',
        paymentMethod: 'Thẻ học sinh',
        merchantName: 'CÔNG TY CỔ PHẦN CÔNG NGHIỆP FINVIET',
        merchantCode: 'FINVIET',
        storeName: 'Như thế học sinh',
        storeCode: 'FINVIET4917.T',
        totalPayout: '3,900 đ',
        txnFee: '132,000 đ',
        userFee: '0 đ',
        deductedRefundAmount: '0 đ',
        description: 'Đối soát định kỳ giao dịch Thẻ học sinh ngày 08/08',
        rejectReason: 'Dữ liệu đối soát khớp 100%',
        merchantPayTime: '08-08-2025 11:00:00',
        statusText: 'Đã phê duyệt',
        statusClass: 'badge-success',
        ecoWallet: '0987654321',
        accountOwner: 'CÔNG TY CP CN FINVIET',
        accountNumber: '190366889988',
        bankName: 'MB Bank (Ngân hàng Quân Đội)',
        bankBranch: 'Chi nhánh Hà Nội',
        totalTxnCount: 12,
        totalOriginalAmount: '6,000,000 đ',
        totalOrderAmount: '6,000,000 đ',
        totalRefundAmount: '0 đ',
        refundFee: '0 đ',
        txnFee: '132,000 đ',
        postpaidBizFee: '0 đ',
        postpaidBizServiceFee: '0 đ',
        postpaidUserFee: '0 đ',
        postpaidUserServiceFee: '0 đ',
        bnplBizFee: '0 đ',
        bnplUserFee: '0 đ',
        bnplUserServiceFee: '0 đ',
        deductedRefundAmount: '0 đ',
        deductedRefundFee: '0 đ',
        finalPayableAmount: '5,868,000 đ',
        extraFee: '-',
        auditLogs: [
          { step: '1. Thời gian thanh toán được tạo', time: '08-08-2025 09:40:10', status: 'Thành công' },
          { step: '2. Thời gian thanh toán được duyệt', time: '08-08-2025 10:15:00', status: 'Đã duyệt' },
          { step: '3. Thời gian thanh toán được chấp nhận duyệt', time: '08-08-2025 10:15:30', status: 'Đã chấp nhận' },
          { step: '4. Thời gian thanh toán duyệt trả tiền', time: '08-08-2025 11:00:00', status: 'Đã phê duyệt' }
        ]
      },
      {
        stt: 2,
        reconcileCode: 'R_102106_08082025_083734_478',
        createdAt: '08-08-2025 08:37:34',
        periodRange: '08-08-2025 00:00 ~ 08-08-2025 23:59',
        paymentMethod: 'Thẻ học sinh',
        merchantName: 'CÔNG TY CỔ PHẦN CÔNG NGHIỆP FINVIET',
        merchantCode: 'FINVIET',
        storeName: 'Chi nhánh Hoàn Kiếm',
        storeCode: 'FINVIET0812',
        totalPayout: '18,900 đ',
        statusText: 'Đã thanh toán',
        statusClass: 'badge-processing',
        ecoWallet: '0987654321',
        accountOwner: 'CÔNG TY CP CN FINVIET',
        ...
        totalTxnCount: 45,
        totalOriginalAmount: '19,200,000 đ',
        totalOrderAmount: '19,200,000 đ',
        totalRefundAmount: '0 đ',
        refundFee: '0 đ',
        txnFee: '300,000 đ',
        postpaidBizFee: '0 đ',
        ...
        deductedRefundAmount: '0 đ',
        deductedRefundFee: '0 đ',
        finalPayableAmount: '18,900,000 đ',
        extraFee: '-',
        auditLogs: [
          { step: '1. Thời gian thanh toán được tạo', time: '08-08-2025 08:37:34', status: 'Thành công' },
          { step: '2. Thời gian thanh toán được duyệt', time: '08-08-2025 09:00:00', status: 'Đã duyệt' },
          { step: '3. Thời gian thanh toán được chấp nhận duyệt', time: '08-08-2025 09:05:00', status: 'Đã chấp nhận' },
          { step: '4. Thời gian thanh toán duyệt trả tiền', time: '08-08-2025 09:30:00', status: 'Đã thanh toán' }
        ]
      },
      {
        stt: 3,
        reconcileCode: 'R_102105_07082025_192803_893',
        createdAt: '07-08-2025 19:28:03',
        periodRange: '07-08-2025 00:00 ~ 07-08-2025 23:59',
        paymentMethod: 'QR Code',
        merchantName: 'CÔNG TY CP TNHH NGÂN TRƯỜNG',
        merchantCode: 'NGAN_TRUONG_01',
        storeName: 'Cửa hàng SmartPOS Cửa NGÂN',
        storeCode: 'MERCHANTHUNGAN1',
        totalPayout: '7,800 đ',
        statusText: 'Đã thanh toán',
        statusClass: 'badge-processing',
        ecoWallet: '0912345678',
        accountOwner: 'FITNESS SQ BROTHERS',
        accountNumber: '666888688688',
        bankName: 'MB Bank',
        bankBranch: 'HỒ CHÍ MINH',
        totalTxnCount: 18,
        totalOriginalAmount: '8,000,000 đ',
        totalOrderAmount: '8,000,000 đ',
        totalRefundAmount: '0 đ',
        refundFee: '0 đ',
        txnFee: '200,000 đ',
        postpaidBizFee: '0 đ',
        ...
        deductedRefundAmount: '0 đ',
        deductedRefundFee: '0 đ',
        finalPayableAmount: '7,800,000 đ',
        extraFee: '-',
        auditLogs: [
          { step: '1. Thời gian thanh toán được tạo', time: '07-08-2025 19:28:03', status: 'Thành công' },
          { step: '2. Thời gian thanh toán được duyệt', time: '07-08-2025 20:00:00', status: 'Đã duyệt' },
          { step: '3. Thời gian thanh toán được chấp nhận duyệt', time: '07-08-2025 20:10:00', status: 'Đã chấp nhận' },
          { step: '4. Thời gian thanh toán duyệt trả tiền', time: '07-08-2025 20:30:00', status: 'Đã thanh toán' }
        ]
      },
      {
        stt: 4,
        reconcileCode: 'R_102104_07082025_191314_314',
        createdAt: '07-08-2025 19:13:14',
        periodRange: '07-08-2025 00:00 ~ 07-08-2025 23:59',
        paymentMethod: 'QR Code',
        merchantName: 'MERCHANTTHUNGAN',
        merchantCode: 'NGAN_TRUONG',
        storeName: 'Chi nhánh Quận 1 - Hồ Chí Minh',
        storeCode: 'MERCHANT_Q1',
        totalPayout: '-62,100 đ',
        statusText: 'Đã thanh toán',
        statusClass: 'badge-processing',
        ecoWallet: '0903332211',
        accountOwner: 'MERCHANT THU NGAN',
        accountNumber: '999888777666',
        bankName: 'Techcombank',
        bankBranch: 'Chi nhánh Quận 1',
        totalTxnCount: 5,
        totalOriginalAmount: '1,200,000 đ',
        totalOrderAmount: '1,200,000 đ',
        totalRefundAmount: '1,262,100 đ',
        refundFee: '0 đ',
        txnFee: '0 đ',
        postpaidBizFee: '0 đ',
        postpaidBizServiceFee: '0 đ',
        ...
        bnplUserFee: '0 đ',
        bnplUserServiceFee: '0 đ',
        deductedRefundAmount: '62,100 đ',
        deductedRefundFee: '0 đ',
        finalPayableAmount: '-62,100 đ',
        extraFee: '-',
        auditLogs: [
          { step: '1. Thời gian thanh toán được tạo', time: '07-08-2025 19:13:14', status: 'Thành công' },
          { step: '2. Thời gian thanh toán được duyệt', time: '07-08-2025 19:30:00', status: 'Đã duyệt' },
          { step: '3. Thời gian thanh toán được chấp nhận duyệt', time: '07-08-2025 19:35:00', status: 'Đã chấp nhận' },
          { step: '4. Thời gian thanh toán duyệt trả tiền', time: '07-08-2025 20:00:00', status: 'Đã thanh toán' }
        ]
      },
      {
        stt: 5,
        reconcileCode: 'R_102103_06082025_142010_112',
        createdAt: '06-08-2025 14:20:10',
        periodRange: '06-08-2025 00:00 ~ 06-08-2025 23:59',
        paymentMethod: 'BNPL (Trả chậm)',
        merchantName: 'CÔNG TY CỔ PHẦN CÔNG NGHIỆP FINVIET',
        merchantCode: 'FINVIET',
        storeName: 'Chi nhánh Hải Châu - Đà Nẵng',
        storeCode: 'FINVIET_DN01',
        totalPayout: '665,710,886 đ',
        statusText: 'Đã phê duyệt',
        statusClass: 'badge-success',
        ecoWallet: '0987654321',
        accountOwner: 'CÔNG TY CP CN FINVIET',
        ...
        totalTxnCount: 1420,
        totalOriginalAmount: '670,000,000 đ',
        totalOrderAmount: '670,000,000 đ',
        totalRefundAmount: '0 đ',
        refundFee: '0 đ',
        txnFee: '4,289,114 đ',
        postpaidBizFee: '0 đ',
        ...
        deductedRefundAmount: '0 đ',
        deductedRefundFee: '0 đ',
        finalPayableAmount: '665,710,886 đ',
        extraFee: '-',
        auditLogs: [
          { step: '1. Thời gian thanh toán được tạo', time: '06-08-2025 14:20:10', status: 'Thành công' },
          { step: '2. Thời gian thanh toán được duyệt', time: '06-08-2025 15:00:00', status: 'Đã duyệt' },
          { step: '3. Thời gian thanh toán được chấp nhận duyệt', time: '06-08-2025 15:10:00', status: 'Đã chấp nhận' },
          { step: '4. Thời gian thanh toán duyệt trả tiền', time: '06-08-2025 16:00:00', status: 'Đã phê duyệt' }
        ]
      }
    ];
  },
